...
<div class="giiant-crud donasi-event-view">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <?php $this->beginBlock('app\models\DonasiEvent'); ?>
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        'attribute' => 'event',
                        'value' => \app\models\Event::findOne($model->event)->judul,
                    ],
                    [
                        'attribute' => 'donatur',
            ...
            <?= Tabs::widget(
                [
                    ...
                    'items' => [[
                        ...
                        'content' => $this->blocks['app\models\DonasiEvent'],
                        'active' => true,
                    ],]
                ]
            );
