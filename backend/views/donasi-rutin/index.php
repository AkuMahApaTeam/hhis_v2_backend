 ...
 * @var app\models\DonasiRutinSearch $searchModel
 */

$this->title = 'DonasiRutins';
...
?>
<div class="giiant-crud donasi-rutin-index">
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Data <?= Yii::t('app', 'DonasiRutins') ?></h3>
    </div>
