 ...
 * @var app\models\DonasiSearch $searchModel
 */
...
?>
<div class="giiant-crud donasi-index">
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Data <?= Yii::t('app', 'Donasis') ?></h3>
    </div>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value'=>function($data){
                            return \app\models\Mahasiswa::find($data->id_mahasiswa)->one()->nama_lengkap;
                        }
                    ],
                    [
                        'attribute'=>'jumlah',
