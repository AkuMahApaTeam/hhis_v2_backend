 ...
 * @property \app\models\DaftarPenyakit $diagnosa0
...
abstract class Riwayat extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_dokter'], 'exist', 'skipOnError' => true, 'targetClass' => \app\models\Dokter::className(), 'targetAttribute' => ['id_dokter' => 'id_dokter']],
            [['diagnosa'], 'exist', 'skipOnError' => true, 'targetClass' => \app\models\DaftarPenyakit::className(), 'targetAttribute' => ['diagnosa' => 'id']]
        ];
    }
    ...
    {
        return $this->hasOne(\app\models\Pasien::className(), ['id_pasien' => 'id_pasien']);
    }
    ...
    {
        return $this->hasOne(\app\models\Dokter::className(), ['id_dokter' => 'id_dokter']);
    }
