...
[widget documentation and demos](http://demos.krajee.com/widget-details/select2) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-widget-select2
---------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-widget-select2_.
...
- What version of jQuery are you using? And what version of yii2-widget-select2?
- Are you using yii2-widget-select2 with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-widget-select2
------------------------------------------
Before starting work on a major feature for yii2-widget-select2, **read the
[documentation](http://demos.krajee.com/widget-details/select2)  first** or you may risk spending a considerable amount of
...
yii2-widget-select2 regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-widget-select2 that contain test cases and
...
It should also be made clear that **all code contributed to yii2-widget-select2** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[isolated-case]: https://jsfiddle.net/
[issue-search]: https://github.com/kartik-v/yii2-widget-select2/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-widget-select2/issues
[licensing]: https://github.com/kartik-v/yii2-widget-select2/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-widget-select2
=======
Contributing to yii2-widget-select2
===================================
Looking to contribute something to yii2-widget-select2? **Here's how you can help.**
...
[reporting-bugs]: #reporting-bugs-with-yii2-widget-select2
>>>>>>> api
[requesting-features]: #requesting-features-in-yii2-widget-select2