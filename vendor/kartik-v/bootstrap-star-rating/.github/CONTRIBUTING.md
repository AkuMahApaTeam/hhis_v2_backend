<<<<<<< HEAD
Contributing to bootstrap-star-rating
=====================================
Looking to contribute something to bootstrap-star-rating? **Here's how you can help.**
...
[plugin documentation](http://plugins.krajee.com/star-rating), 
[plugin demos](http://plugins.krajee.com/star-rating/demo), and / or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with bootstrap-star-rating
-----------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within bootstrap-star-rating_.
...
- What version of jQuery are you using? And what version of bootstrap-star-rating?
- Are you using bootstrap-star-rating with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in bootstrap-star-rating
------------------------------------------
Before starting work on a major feature for bootstrap-star-rating, **read the
[documentation](http://plugins.krajee.com/star-rating)  first** or you may risk spending a considerable amount of
...
bootstrap-star-rating regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to bootstrap-star-rating that contain test cases and
...
It should also be made clear that **all code contributed to bootstrap-star-rating** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[isolated-case]: https://jsfiddle.net/
[issue-search]: https://github.com/kartik-v/bootstrap-star-rating/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/bootstrap-star-rating/issues
[licensing]: https://github.com/kartik-v/bootstrap-star-rating/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-bootstrap-star-rating
=======
Contributing to bootstrap-star-rating
=====================================
Looking to contribute something to bootstrap-star-rating? **Here's how you can help.**
...
[reporting-bugs]: #reporting-bugs-with-bootstrap-star-rating
>>>>>>> api
[requesting-features]: #requesting-features-in-bootstrap-star-rating